...
class Panel extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      >
        <div className="accordion-header panel__label"
          role='tab'
          onClick={activateTab}
        >
          {/* {
        ...
        <div className="accordion-body panel__inner"
          style={innerStyle}
